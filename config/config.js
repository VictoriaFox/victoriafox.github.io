var config = {
    ...
    age: "19",
    phone: "19872222222",
    email: "mayuqing@buaa.edu.cn or vickyfoxmyq@gmail.com",
    address: "Room G609, New Main Building, No.37 Xueyuan Rd., Beijing, China",
    qq: "11",
    log: "",
    excpect_work: "Associate Professor",
    ...
    welcome: "I’m currently an associate professor with the Institute of Artificial Intelligence at Beihang University, Beijing, China. Previously I was a postdoctoral fellow in NLSDE at Beihang University, advised by Xianglong Liu. I received my PhD from Beihang University (2021), under the supervision of Prof. Wei Li. Before that, I received my B.Sc. degree in Computer Science and Technology, Shandong University, in 2015. <br>" ,
            //  "但为君故，沉吟至今<br>" +
    ...
    */  
     ...
     */
    portfolio: [
        ["./images/pro-1.png", "http://1.15.234.109:8000/", "Annealing-based Label-Transfer Learning for Open World Object Detection.", "这里记录了我的Java后端学习笔记<br>持续更新"],
    ...
    work: [
        ...
        // ["2020/7/1 — 2021/8/10", "<img src='./images/cvpr2023.png' alt='cvpr2023' width='200px' height='165px'>",
        //     "<p><strong>Annealing-based Label-Transfer Learning for Open World Object Detection.</strong></p>" +
